    ...
    with col3:
        ...
        if st.button('Predict'):
            ...
            if probability > 0.8:
                ...
                # Low risk
                st.markdown(f"<span style='color: #0c6938;'>The probability of a terrorist attack in {state} is: {probability:.2%}.</span>", unsafe_allow_html=True)
                st.markdown("<div style='background-color: #c3ded0; color: #0c6938; border-radius:5px; padding: 10px;'>"
