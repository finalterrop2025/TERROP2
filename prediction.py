...
#<div data-testid="stMarkdownContainer" class="st-emotion-cache-1jmvea6 e1nzilvr4"><p>State</p></div>
    ...
    with col3:
        ...
        if st.button('Predict'):
            ...
            if probability > 0.8:  
                # Very high risk
                st.markdown(f"<span style='color:#bf0404;'>The probability of a terrorist attack in {state} is: {probability:.2%}.</span>", unsafe_allow_html=True)
                st.markdown("<div style='background-color: #f2bfbf; color: #f50707; border-radius:8px; padding: 15px;  text-align: justify;'>"
