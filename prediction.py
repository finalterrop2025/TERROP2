    ...
    with col3:
        ...
        if st.button('Predict'):
            ...
            if probability > 0.8:
                ...
                # High risk
                st.markdown(f"<span style='color: #e6cab5;'>The probability of a terrorist attack in {state} is: {probability:.2%}.</span>", unsafe_allow_html=True)
                st.markdown("<div style='background-color: #e6cab5; color: #753707; border-radius:8px; padding: 15px;  text-align: justify;'>"
