    ...
    st.markdown(
        """
            <style>
                ...
                div.css-1lcbmhc {
                    margin-right: 50px; /* to increase the space */
                }
            </style>
        """, unsafe_allow_html=True
    )
...
#<div data-testid="stMarkdownContainer" class="st-emotion-cache-1jmvea6 e1nzilvr4"><p>State</p></div>
    ...
    with col3:
        ...
        if st.button('Predict'):
            ...
            if probability > 0.8:  
                # Very high risk
                st.markdown(f"<span style='color: #fc4245; font-size: 20px;'>The probability of a terrorist attack in {state} is: {probability:.2%}.</span>", unsafe_allow_html=True)
                st.markdown("<div style='background-color: #e0d7d7; color: #e30505; border-radius:8px; padding: 15px;  text-align: justify; font-size: 16px;'>"
                ...
                # High risk
                st.markdown(f"<span style='color: #fc6f03; font-size: 20px;'>The probability of a terrorist attack in {state} is: {probability:.2%}.</span>", unsafe_allow_html=True)
                st.markdown("<div style='background-color: #edd8c7; color: #6e360b; border-radius:8px; padding: 15px;  text-align: justify; font-size: 16px;'>"
                ...
                # Moderate risk
                st.markdown(f"<span style='color:#e3d7b1; font-size: 20px;'>The probability of a terrorist attack in {state} is: {probability:.2%}.</span>", unsafe_allow_html=True)
                st.markdown("<div style='background-color: #e3d7b1; color: #614c08; border-radius:8px; padding: 15px;  text-align: justify; font-size: 16px;'>"
                ...
                # Low risk
                st.markdown(f"<span style='color: #defaec; font-size: 20px;'>The probability of a terrorist attack in {state} is: {probability:.2%}.</span>", unsafe_allow_html=True)
                st.markdown("<div style='background-color: #c3ded0; color: #0c6938; border-radius:8px; padding: 15px;  text-align: justify; font-size: 16px;'>"
